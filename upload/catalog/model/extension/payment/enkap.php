...
class ModelExtensionPaymentEnkap extends Model {
	...
	public function addOrderTransactionId($order_id, $merchantReference, $order_transaction_id){
		$this->db->query("INSERT INTO `" . DB_PREFIX . "enkap_transaction` SET order_id = '" . (int)$order_id . "', `order_transaction_id` = '" . $order_transaction_id . "', `merchantReference` = '" . $merchantReference . "'");
	}
